...
| **Pre-qualification (budget, timeline, flexibility)** | Automatic on the residence and Contact forms. Wording and options: Customize › the form › **Pre-qualification** | Three optional dropdowns. Answers arrive in the enquiry email; budget and timeline also become tags in Customers (`budget-5m-6m`, `timeline-ready-now`), so a segment like `customer_tags CONTAINS 'timeline-ready-now'` is your hot list. If they skip them, the thank-you asks for budget and timeline in your words |
