...
| Add a brand-new residence | Products › **Add product** | Title, description, photos (first = hero), then fill the metafields at the bottom incl. **Status**. Untick Track quantity / leave price 0. It appears everywhere on Save |
...
| Home film: words clash with the film's own SABDIA | Customize › Home › **Hero slideshow** › *Hold the words back* / *Where the words sit* | Delay the title by a few seconds, or move it Lower / Upper |
